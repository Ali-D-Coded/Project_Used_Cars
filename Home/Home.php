...
if (isset($_SESSION['uid']) && isset($_SESSION['Name'])) {
 ...
 $result=mysqli_query($dbconnect,"SELECT Name FROM User_Info WHERE user_id='$current_user';");
...
<body>
  ...
  <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active navia" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="false"  href="#">Home</a>
    </li>
    <li class="nav-item">
    ...
    <div class="container pb-5">
      <div class="row py-5 align-items-center">
        <div class="col-lg-6">
          ...
          <h5 class="display-4 mb-4 font-weight-bold text-white">Welcome <?php echo $_SESSION['Name']; ?></h>
